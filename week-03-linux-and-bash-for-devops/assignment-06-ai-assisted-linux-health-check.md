...
![Nginx healthy baseline screenshot](<screenshots/nginx-baseline.png>)

#### Screenshot 2 — Output of `pwd` and `find . -maxdepth 4 -type d | sort` showing the workspace folder structure

![Workspace folder structure screenshot](<screenshots/workspace-structure.png>)
...
![CLAUDE.md configuration screenshot](<screenshots/claude-md-config.png>)
...
![Claude planning screenshot](<screenshots/claude-planning.png>)
...
![Linux triage script variables section screenshot](<screenshots/triage-variables.png>)

#### Screenshot 6 — Middle section showing check functions and conditionals

![Linux triage script functions section screenshot](<screenshots/triage-functions.png>)
...
![Script syntax validation screenshot](<screenshots/script-validation.png>)
---
...
![Triage script healthy output screenshot](<screenshots/triage-healthy.png>)

#### Screenshot 10 — Output showing the captured exit code and final summary

![Triage exit code and summary screenshot](<screenshots/triage-summary.png>)
...
![Linux triage skill SKILL.md screenshot](<screenshots/triage-skill.png>)

#### Screenshot 12 — `/linux-triage` output for the healthy server

![Linux triage skill output screenshot](<screenshots/triage-skill-output.png>)
...
![Triage diagnosis screenshot](<screenshots/triage-diagnosis.png>)

#### Screenshot 15 — `incident-failure-report.txt` showing the failed checks and your Full Name

![Incident failure report screenshot](<screenshots/incident-report.png>)
...
![Nginx recovery screenshot](<screenshots/nginx-recovery.png>)

#### Screenshot 17 — Second `/linux-triage` output showing successful recovery with no FAIL results

![Recovery verification screenshot](<screenshots/recovery-verification.png>)

#### Screenshot 18 — Output of `ls -lah reports` showing both `incident-failure-report.txt` and `recovery-report.txt`

![Reports directory listing screenshot](<screenshots/reports-listing.png>)

#### Screenshot 19 — `incident-summary.md` showing all required sections and your Full Name

![Incident summary document screenshot](<screenshots/incident-summary.png>)
...
https://www.linkedin.com/posts/silas-nyarko_dmi-cohort-4-live-micro-internship-waiting-share-7483869993701482496-V_TA/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAC77mYABXwQj5VAsAS-zzzdbpmvsIZLeP7U

---

#### Screenshot — Published LinkedIn post

![LinkedIn triage post screenshot](<screenshots/linkedin-triage-post.png>)
...
- [X] Task 7: Nginx incident simulated and triage diagnosed failure (Screenshots 13–15, Notes answered)
